...
let { cannot } = require("../constants/Fields");

class Client extends EventEmitter {

    /**
     * @param {string|undefined} token the token string used for logging in.
     * 
    ...
    /**
     * @param {string|undefined} The token that will be used same as in the constructor.
     */
    startGateway(token) {
       let login = cannot.includes(this.token) ? token : this.token;
